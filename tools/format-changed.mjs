...
// Spawn prettier's JS entry via node directly: newer Node versions refuse to
// spawn .cmd shims (EINVAL), so neither prettier nor prettier.cmd is portable —
// the JS entry point runs everywhere.
