...
export default defineConfig({
  // Bundle everything into the shell main: the imported slides main modules
  // are TS source with no build artifacts, so externalizing them would break
  // Node ESM resolution at runtime.
  main: {},
  preload: {
    build: {
      rollupOptions: {
