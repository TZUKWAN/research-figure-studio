...
function SlideIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" aria-hidden="true">
      <rect x="3" y="5" width="18" height="12.5" rx="2" stroke="currentColor" strokeWidth="1.5" />
      <path d="M8 21h8M12 17.5V21" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
      <path
        d="M7.5 12.5l3-3.5 2.5 2.5 2-2.5 1.5 2"
        stroke="currentColor"
        strokeWidth="1.3"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export function TabBar() {
  ...
  // Slides tabs are sibling WebContentsViews: they see neither this press
    ...
    <div className="tab-bar">
      ...
      <div className={dragVisual ? 'tab-strip dragging' : 'tab-strip'} ref={stripRef}>
        ...
        <button
          ...
          title={t('newSlide')}
          aria-label={t('newSlide')}
          onClick={() => void window.aiOffice.newSlide()}
        >
