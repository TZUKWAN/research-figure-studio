...
export const strings = {
  zh: {
    ...
    navRecent: '最近',
    navStarred: '收藏',
    navCloud: 'Metis Projects',
    cloudSubtitle: '在网页端用 Metis AI 创建的项目。编辑在浏览器中继续——点击任意项目即可打开。',
    ...
    cloudSortOldest: '最早',
    cloudRefresh: '刷新',
    cloudLoginHint: '登录 Metis 账号，查看你在网页端创建的项目。',
    cloudEmpty: '还没有网页端项目。',
    ...
    newSlide: '新建画布',
    openLocal: '打开本地文件',
    importIntoProject: '导入文件',
    setSecStandards: '规范',
    setStandardsNote:
      '仅可编辑 AI 绘图的提示词文本；组件注册表、布局规则与 QA 阈值等核心配置不可修改。',
    setStandardsLoadError: '规范加载失败，请重试。',
    setStandardsSave: '保存提示词',
    setStandardsReset: '恢复默认',
    setAiProbe: '探测模型',
    setAiProbing: '探测中…',
    setAiMaxContext: '最大上下文 (tokens)',
    setAiMaxContextHint: '模型的输入窗口上限；探测成功后自动填入',
    setAiMaxOutput: '最大输出 (tokens)',
    setAiMaxOutputHint: '单次回复的输出上限；探测成功后自动填入',
    setAiVision: '支持图片输入（多模态）',
    setAiVisionHint: '勾选后 AI 功能才会向该模型发送图片',
    setAiUnknown: '未知',
    greetMorning: '早上好',
    greetAfternoon: '下午好',
    greetEvening: '晚上好',
    ...
    noContent: '（无内容）',
    // Account
    accountMetis: 'Metis 账号',
    account: '账号',
    login: '登录',
    loginMetis: '登录 Metis 账号',
    loggedIn: '已登录',
    loggedInMetis: '已登录 Metis',
    ...
    loginCopyUrl: '复制登录链接',
    loginCopied: '已复制',
    loginNetworkError: '无法连接 Metis,请检查网络或代理设置',
    ...
    setAiByokNote: '所有 AI 功能均使用你在此配置的 API Key；密钥仅保存在本机。',
    setAiSave: '保存',
    setAiSaved: '已保存',
    setAiTest: '测试连接',
    setAiTesting: '测试中…',
  ...
  en: {
    ...
    navCloud: 'Metis Projects',
    cloudSubtitle:
      'Projects created on the web with Metis AI. Editing continues in your browser — click any project to open it.',
    ...
    cloudLoginHint: 'Sign in to your Metis account to see projects you created on the web.',
    ...
    importIntoProject: 'Import files',
    setSecStandards: 'Standards',
    setStandardsNote:
      'Only AI drawing prompt text is editable; the Component Registry, layout rules and QA thresholds stay code-owned.',
    setStandardsLoadError: 'Failed to load standards. Please try again.',
    setStandardsSave: 'Save prompt',
    setStandardsReset: 'Reset to default',
    setAiProbe: 'Discover',
    setAiProbing: 'Discovering…',
    setAiMaxContext: 'Max context (tokens)',
    setAiMaxContextHint: 'Model input window; auto-filled after discovery',
    setAiMaxOutput: 'Max output (tokens)',
    setAiMaxOutputHint: 'Per-reply output ceiling; auto-filled after discovery',
    setAiVision: 'Supports image input (multimodal)',
    setAiVisionHint: 'AI features send images to this model only when enabled',
    setAiUnknown: 'Unknown',
    ...
    untitled: 'Untitled',
    noContent: '(empty)',
    accountMetis: 'Metis Account',
    account: 'Account',
    login: 'Sign in',
    loginMetis: 'Sign in with Metis',
    loggedIn: 'Signed in',
    loggedInMetis: 'Signed in to Metis',
    ...
    loginCopied: 'Copied',
    loginNetworkError: 'Cannot reach Metis — check your network or proxy settings',
    ...
    setAiByokNote:
      'All AI features use the API key configured here; it is stored only on this device.',
    setAiSave: 'Save',
    setAiSaved: 'Saved',
  ...
  ja: {
    ...
    navCloud: 'Metis Projects',
    cloudSubtitle:
      'Web で Metis AI を使って作成したプロジェクト。編集はブラウザで続行します。クリックで開きます。',
    ...
    cloudRefresh: '更新',
    cloudLoginHint:
      'Metis アカウントにサインインすると、Web で作成したプロジェクトを表示できます。',
    ...
    importIntoProject: 'ファイルを取り込む',
    setSecStandards: 'スタイル規範',
    setStandardsNote:
      '編集できるのは AI 描画のプロンプト文のみです。コンポーネント登録やレイアウト規則、QA しきい値は変更できません。',
    setStandardsLoadError: 'スタイル規範の読み込みに失敗しました。再試行してください。',
    setStandardsSave: 'プロンプトを保存',
    setStandardsReset: '既定に戻す',
    setAiProbe: 'モデル探索',
    setAiProbing: '探索中…',
    setAiMaxContext: '最大コンテキスト (tokens)',
    setAiMaxContextHint: 'モデルの入力ウィンドウ上限。探索後に自動入力',
    setAiMaxOutput: '最大出力 (tokens)',
    setAiMaxOutputHint: '1 回の応答の出力上限。探索後に自動入力',
    setAiVision: '画像入力に対応（マルチモーダル）',
    setAiVisionHint: '有効時のみ AI 機能がこのモデルへ画像を送信',
    setAiUnknown: '不明',
    ...
    noContent: '（内容なし）',
    // Account
    accountMetis: 'Metis アカウント',
    account: 'アカウント',
    login: 'サインイン',
    loginMetis: 'Metis アカウントでサインイン',
    loggedIn: 'サインイン済み',
    loggedInMetis: 'Metis にサインイン済み',
    waitingLogin:
    ...
    loginCopied: 'コピーしました',
    loginNetworkError: 'Metis に接続できません。ネットワークまたはプロキシ設定を確認してください',
    ...
    setAiByokNote:
      'すべての AI 機能は、ここで設定した API キーを使用します。キーはこのデバイスにのみ保存されます。',
    setAiSave: '保存',
    setAiSaved: '保存しました',
    setAiTest: '接続テスト',
    setAiTesting: 'テスト中…',
  ...
  ko: {
    ...
    navCloud: 'Metis Projects',
    cloudSubtitle:
      'Metis AI로 웹에서 만든 프로젝트입니다. 편집은 브라우저에서 계속됩니다. 프로젝트를 클릭하면 열립니다.',
    ...
    cloudRefresh: '새로고침',
    cloudLoginHint: 'Metis 계정에 로그인하면 웹에서 만든 프로젝트를 볼 수 있습니다.',
    ...
    newSlide: '새 캔버스',
    openLocal: '로컬 파일 열기',
    importIntoProject: '파일 가져오기',
    setSecStandards: '표준 규범',
    setStandardsNote:
      'AI 그리기 프롬프트 텍스트만 편집할 수 있습니다. 컴포넌트 레지스트리·레이아웃 규칙·QA 임계값은 수정할 수 없습니다.',
    setStandardsLoadError: '표준 규범을 불러오지 못했습니다. 다시 시도하세요.',
    setStandardsSave: '프롬프트 저장',
    setStandardsReset: '기본값으로 초기화',
    setAiProbe: '모델 탐색',
    setAiProbing: '탐색 중…',
    setAiMaxContext: '최대 컨텍스트 (tokens)',
    setAiMaxContextHint: '모델 입력 창 상한, 탐색 후 자동 입력',
    setAiMaxOutput: '최대 출력 (tokens)',
    setAiMaxOutputHint: '응답당 출력 상한, 탐색 후 자동 입력',
    setAiVision: '이미지 입력 지원(멀티모달)',
    setAiVisionHint: '활성화 시에만 AI 기능이 이 모델로 이미지 전송',
    setAiUnknown: '알 수 없음',
    ...
    noContent: '(내용 없음)',
    // Account
    accountMetis: 'Metis 계정',
    account: '계정',
    login: '로그인',
    loginMetis: 'Metis 계정으로 로그인',
    loggedIn: '로그인됨',
    loggedInMetis: 'Metis에 로그인됨',
    ...
    loginCopied: '복사됨',
    loginNetworkError: 'Metis에 연결할 수 없습니다. 네트워크 또는 프록시 설정을 확인하세요',
    ...
    setAiByokNote: '모든 AI 기능은 여기에서 설정한 API 키를 사용하며, 키는 이 기기에만 저장됩니다.',
    setAiSave: '저장',
    setAiSaved: '저장됨',
    setAiTest: '연결 테스트',
    setAiTesting: '테스트 중…',
  ...
  fr: {
    ...
    navCloud: 'Metis Projects',
    cloudSubtitle:
      "Projets créés sur le web avec Metis AI. L'édition continue dans votre navigateur — cliquez sur un projet pour l'ouvrir.",
    ...
    cloudLoginHint: 'Connectez-vous à votre compte Metis pour voir les projets créés sur le web.',
    ...
    colSize: 'Taille',
    // Quick start
    newSlide: 'Nouvelle toile',
    openLocal: 'Ouvrir un fichier local',
    importIntoProject: 'Importer des fichiers',
    setSecStandards: 'Standards',
    setStandardsNote:
      'Seul le texte des prompts est modifiable ; registre de composants, règles de mise en page et seuils QA restent réservés.',
    setStandardsLoadError: 'Échec du chargement des standards. Réessayez.',
    setStandardsSave: 'Enregistrer le prompt',
    setStandardsReset: 'Rétablir par défaut',
    setAiProbe: 'Détecter',
    setAiProbing: 'Détection…',
    setAiMaxContext: 'Contexte max (tokens)',
    setAiMaxContextHint: 'Fenêtre d’entrée du modèle, remplie après détection',
    setAiMaxOutput: 'Sortie max (tokens)',
    setAiMaxOutputHint: 'Plafond de sortie par réponse, rempli après détection',
    setAiVision: 'Prend en charge les images (multimodal)',
    setAiVisionHint: 'Les fonctions IA n’envoient des images que si activé',
    setAiUnknown: 'Inconnu',
    ...
    noContent: '(vide)',
    // Account
    accountMetis: 'Compte Metis',
    account: 'Compte',
    login: 'Se connecter',
    loginMetis: 'Se connecter avec Metis',
    loggedIn: 'Connecté',
    loggedInMetis: 'Connecté à Metis',
    waitingLogin:
    ...
    loginCopied: 'Copié',
    loginNetworkError:
      'Impossible de joindre Metis — vérifiez votre réseau ou vos paramètres de proxy',
    ...
    setAiByokNote:
      'Toutes les fonctionnalités d’IA utilisent la clé API configurée ici ; elle est stockée uniquement sur cet appareil.',
  ...
  de: {
    ...
    navCloud: 'Metis Projects',
    cloudSubtitle:
      'Mit Metis AI im Web erstellte Projekte. Die Bearbeitung läuft im Browser weiter – klicken Sie auf ein Projekt, um es zu öffnen.',
    ...
    cloudLoginHint:
      'Melden Sie sich bei Ihrem Metis-Konto an, um Ihre im Web erstellten Projekte zu sehen.',
    ...
    colSize: 'Größe',
    // Quick start
    newSlide: 'Neue Leinwand',
    openLocal: 'Lokale Datei öffnen',
    importIntoProject: 'Dateien importieren',
    setSecStandards: 'Standards',
    setStandardsNote:
      'Nur Prompt-Texte sind bearbeitbar; Komponentenregistry, Layoutregeln und QA-Schwellen bleiben geschützt.',
    setStandardsLoadError: 'Standards konnten nicht geladen werden. Bitte erneut versuchen.',
    setStandardsSave: 'Prompt speichern',
    setStandardsReset: 'Auf Standard zurücksetzen',
    setAiProbe: 'Erkennen',
    setAiProbing: 'Erkenne…',
    setAiMaxContext: 'Max. Kontext (Tokens)',
    setAiMaxContextHint: 'Eingabefenster des Modells, nach Erkennen ausgefüllt',
    setAiMaxOutput: 'Max. Ausgabe (Tokens)',
    setAiMaxOutputHint: 'Ausgabelimit pro Antwort, nach Erkennen ausgefüllt',
    setAiVision: 'Bildeingabe unterstützt (multimodal)',
    setAiVisionHint: 'KI-Funktionen senden nur bei Aktivierung Bilder',
    setAiUnknown: 'Unbekannt',
    ...
    noContent: '(leer)',
    // Account
    accountMetis: 'Metis-Konto',
    account: 'Konto',
    login: 'Anmelden',
    loginMetis: 'Mit Metis anmelden',
    loggedIn: 'Angemeldet',
    loggedInMetis: 'Bei Metis angemeldet',
    waitingLogin:
    ...
    loginCopied: 'Kopiert',
    loginNetworkError: 'Metis ist nicht erreichbar — prüfen Sie Netzwerk- oder Proxy-Einstellungen',
    ...
    setAiByokNote:
      'Alle KI-Funktionen verwenden den hier konfigurierten API-Schlüssel; er wird nur auf diesem Gerät gespeichert.',
    setAiSave: 'Speichern',
  ...
  es: {
    ...
    navCloud: 'Metis Projects',
    cloudSubtitle:
      'Proyectos creados en la web con Metis AI. La edición continúa en tu navegador: haz clic en un proyecto para abrirlo.',
    ...
    cloudLoginHint: 'Inicia sesión en tu cuenta de Metis para ver los proyectos creados en la web.',
    ...
    colSize: 'Tamaño',
    // Quick start
    newSlide: 'Nuevo lienzo',
    openLocal: 'Abrir archivo local',
    importIntoProject: 'Importar archivos',
    setSecStandards: 'Estándares',
    setStandardsNote:
      'Solo se edita el texto de los prompts; el registro de componentes, las reglas de diseño y los umbrales de QA no se modifican.',
    setStandardsLoadError: 'No se pudieron cargar los estándares. Inténtalo de nuevo.',
    setStandardsSave: 'Guardar prompt',
    setStandardsReset: 'Restaurar predeterminado',
    setAiProbe: 'Detectar',
    setAiProbing: 'Detectando…',
    setAiMaxContext: 'Contexto máx. (tokens)',
    setAiMaxContextHint: 'Ventana de entrada del modelo; se rellena tras detectar',
    setAiMaxOutput: 'Salida máx. (tokens)',
    setAiMaxOutputHint: 'Límite de salida por respuesta; se rellena tras detectar',
    setAiVision: 'Admite entrada de imágenes (multimodal)',
    setAiVisionHint: 'Las funciones de IA solo envían imágenes si está activado',
    setAiUnknown: 'Desconocido',
    ...
    noContent: '(vacío)',
    // Account
    accountMetis: 'Cuenta de Metis',
    account: 'Cuenta',
    login: 'Iniciar sesión',
    loginMetis: 'Iniciar sesión con Metis',
    loggedIn: 'Sesión iniciada',
    loggedInMetis: 'Sesión iniciada en Metis',
    waitingLogin:
    ...
    loginCopied: 'Copiado',
    loginNetworkError:
      'No se puede conectar con Metis — compruebe su red o la configuración del proxy',
    ...
    setAiByokNote:
      'Todas las funciones de IA usan la clave API configurada aquí; solo se guarda en este dispositivo.',
    setAiSave: 'Guardar',
    setAiSaved: 'Guardado',
  ...
  th: {
    ...
    navCloud: 'Metis Projects',
    cloudSubtitle:
      'โปรเจกต์ที่สร้างบนเว็บด้วย Metis AI แก้ไขต่อได้ในเบราว์เซอร์ — คลิกโปรเจกต์เพื่อเปิด',
    ...
    cloudRefresh: 'รีเฟรช',
    cloudLoginHint: 'ลงชื่อเข้าใช้บัญชี Metis เพื่อดูโปรเจกต์ที่คุณสร้างบนเว็บ',
    ...
    importIntoProject: 'นำเข้าไฟล์',
    setSecStandards: 'มาตรฐาน',
    setStandardsNote: 'แก้ไขได้เฉพาะข้อความพรอมต์ ส่วนกฎเลย์เอาต์และเกณฑ์ QA แก้ไขไม่ได้',
    setStandardsLoadError: 'โหลดมาตรฐานไม่สำเร็จ โปรดลองอีกครั้ง',
    setStandardsSave: 'บันทึกพรอมต์',
    setStandardsReset: 'กลับค่าเริ่มต้น',
    setAiProbe: 'ค้นหาโมเดล',
    setAiProbing: 'กำลังค้นหา…',
    setAiMaxContext: 'คอนเท็กซ์สูงสุด (tokens)',
    setAiMaxContextHint: 'หน้าต่างอินพุตของโมเดล เติมอัตโนมัติหลังค้นหา',
    setAiMaxOutput: 'เอาต์พุตสูงสุด (tokens)',
    setAiMaxOutputHint: 'เพดานเอาต์พุตต่อคำตอบ เติมอัตโนมัติหลังค้นหา',
    setAiVision: 'รับภาพเข้าได้ (มัลติโมเดล)',
    setAiVisionHint: 'ฟีเจอร์ AI ส่งภาพให้โมเดลนี้เมื่อเปิดใช้งาน',
    setAiUnknown: 'ไม่ทราบ',
    ...
    // Account
    accountMetis: 'บัญชี Metis',
    account: 'บัญชี',
    login: 'ลงชื่อเข้าใช้',
    loginMetis: 'ลงชื่อเข้าใช้ด้วย Metis',
    loggedIn: 'ลงชื่อเข้าใช้แล้ว',
    loggedInMetis: 'ลงชื่อเข้าใช้ Metis แล้ว',
    ...
    loginNetworkError: 'ไม่สามารถเชื่อมต่อ Metis ได้ โปรดตรวจสอบเครือข่ายหรือการตั้งค่าพร็อกซี',
    ...
    setAiByokNote:
      'ฟีเจอร์ AI ทั้งหมดใช้ API Key ที่ตั้งค่าที่นี่ และจัดเก็บไว้ในอุปกรณ์นี้เท่านั้น',
    setAiSave: 'บันทึก',
  ...
  id: {
    ...
    navCloud: 'Metis Projects',
    cloudSubtitle:
      'Proyek yang dibuat di web dengan Metis AI. Pengeditan berlanjut di browser — klik proyek untuk membukanya.',
    ...
    cloudLoginHint: 'Masuk ke akun Metis untuk melihat proyek yang Anda buat di web.',
    ...
    colSize: 'Ukuran',
    // Quick start
    newSlide: 'Kanvas baru',
    openLocal: 'Buka File Lokal',
    importIntoProject: 'Impor berkas',
    setSecStandards: 'Standar',
    setStandardsNote:
      'Hanya teks prompt yang dapat diedit; registri komponen, aturan tata letak, dan ambang QA tidak dapat diubah.',
    setStandardsLoadError: 'Gagal memuat standar. Silakan coba lagi.',
    setStandardsSave: 'Simpan prompt',
    setStandardsReset: 'Kembalikan bawaan',
    setAiProbe: 'Deteksi',
    setAiProbing: 'Mendeteksi…',
    setAiMaxContext: 'Konteks maks (token)',
    setAiMaxContextHint: 'Jendela input model, terisi otomatis setelah deteksi',
    setAiMaxOutput: 'Keluaran maks (token)',
    setAiMaxOutputHint: 'Batas keluaran per balasan, terisi otomatis setelah deteksi',
    setAiVision: 'Dukung input gambar (multimodal)',
    setAiVisionHint: 'Fitur AI hanya mengirim gambar jika aktif',
    setAiUnknown: 'Tidak diketahui',
    ...
    noContent: '(kosong)',
    // Account
    accountMetis: 'Akun Metis',
    account: 'Akun',
    login: 'Masuk',
    loginMetis: 'Masuk dengan Metis',
    loggedIn: 'Sudah masuk',
    loggedInMetis: 'Sudah masuk ke Metis',
    ...
    loginCopied: 'Disalin',
    loginNetworkError:
      'Tidak dapat terhubung ke Metis — periksa jaringan atau pengaturan proxy Anda',
    ...
    setAiByokNote:
      'Semua fitur AI menggunakan API key yang dikonfigurasi di sini; key hanya disimpan di perangkat ini.',
    setAiSave: 'Simpan',
  ...
  ru: {
    ...
    navCloud: 'Metis Projects',
    cloudSubtitle:
      'Проекты, созданные в вебе с Metis AI. Редактирование продолжается в браузере — нажмите на проект, чтобы открыть его.',
    ...
    cloudLoginHint: 'Войдите в аккаунт Metis, чтобы увидеть проекты, созданные в вебе.',
    ...
    colSize: 'Размер',
    // Quick start
    newSlide: 'Новый холст',
    openLocal: 'Открыть локальный файл',
    importIntoProject: 'Импортировать файлы',
    setSecStandards: 'Стандарты',
    setStandardsNote:
      'Редактируются только тексты промптов; реестр компонентов, правила вёрстки и пороги QA защищены.',
    setStandardsLoadError: 'Не удалось загрузить стандарты. Повторите попытку.',
    setStandardsSave: 'Сохранить промпт',
    setStandardsReset: 'Сбросить',
    setAiProbe: 'Найти модели',
    setAiProbing: 'Поиск…',
    setAiMaxContext: 'Макс. контекст (токены)',
    setAiMaxContextHint: 'Окно ввода модели; заполняется после поиска',
    setAiMaxOutput: 'Макс. вывод (токены)',
    setAiMaxOutputHint: 'Лимит вывода на ответ; заполняется после поиска',
    setAiVision: 'Поддержка изображений (мультимодальная)',
    setAiVisionHint: 'ИИ-функции шлют изображения только при включении',
    setAiUnknown: 'Неизвестно',
    ...
    noContent: '(пусто)',
    // Account
    accountMetis: 'Учётная запись Metis',
    account: 'Учётная запись',
    login: 'Войти',
    loginMetis: 'Войти через Metis',
    loggedIn: 'Вход выполнен',
    loggedInMetis: 'Выполнен вход в Metis',
    ...
    loginNetworkError: 'Не удаётся подключиться к Metis — проверьте сеть или настройки прокси',
    ...
    setAiByokNote:
      'Все функции ИИ используют API-ключ, настроенный здесь; он хранится только на этом устройстве.',
    setAiSave: 'Сохранить',
  ...
  ar: {
    ...
    navCloud: 'Metis Projects',
    cloudSubtitle:
      'مشاريع أُنشئت على الويب باستخدام Metis AI. يستمر التحرير في المتصفح — انقر على أي مشروع لفتحه.',
    ...
    cloudRefresh: 'تحديث',
    cloudLoginHint: 'سجّل الدخول إلى حساب Metis لعرض المشاريع التي أنشأتها على الويب.',
    ...
    colSize: 'الحجم',
    // Quick start
    newSlide: 'لوحة رسم جديدة',
    openLocal: 'فتح ملف محلي',
    importIntoProject: 'استيراد ملفات',
    setSecStandards: 'المعايير',
    setStandardsNote:
      'يمكن تعديل نصوص الأوامر فقط؛ أما سجل المكونات وقواعد التخطيط وعتبات الجودة فلا.',
    setStandardsLoadError: 'فشل تحميل المعايير. حاول مرة أخرى.',
    setStandardsSave: 'حفظ الأمر',
    setStandardsReset: 'استعادة الافتراضي',
    setAiProbe: 'استكشاف',
    setAiProbing: 'جارٍ الاستكشاف…',
    setAiMaxContext: 'أقصى سياق (توكن)',
    setAiMaxContextHint: 'نافذة إدخال النموذج، تُملأ تلقائيًا بعد الاستكشاف',
    setAiMaxOutput: 'أقصى إخراج (توكن)',
    setAiMaxOutputHint: 'حد الإخراج لكل رد، يُملأ تلقائيًا بعد الاستكشاف',
    setAiVision: 'يدعم إدخال الصور (متعدد الوسائط)',
    setAiVisionHint: 'ترسل ميزات الذكاء الاصطناعي الصور عند التفعيل فقط',
    setAiUnknown: 'غير معروف',
    ...
    noContent: '(فارغ)',
    // Account
    accountMetis: 'حساب Metis',
    account: 'الحساب',
    login: 'تسجيل الدخول',
    loginMetis: 'تسجيل الدخول باستخدام Metis',
    loggedIn: 'تم تسجيل الدخول',
    loggedInMetis: 'تم تسجيل الدخول إلى Metis',
    ...
    loginNetworkError: 'تعذّر الاتصال بـ Metis — تحقق من الشبكة أو إعدادات الوكيل',
    ...
    setAiByokNote:
      'تستخدم جميع ميزات الذكاء الاصطناعي مفتاح API المُعد هنا، ويُحفظ على هذا الجهاز فقط.',
    setAiSave: 'حفظ',
    setAiSaved: 'تم الحفظ',
  ...
  pt: {
    ...
    navCloud: 'Metis Projects',
    cloudSubtitle:
      'Projetos criados na web com o Metis AI. A edição continua no navegador — clique em um projeto para abri-lo.',
    ...
    cloudLoginHint: 'Entre na sua conta Metis para ver os projetos criados na web.',
    ...
    importIntoProject: 'Importar arquivos',
    setSecStandards: 'Padrões',
    setStandardsNote:
      'Apenas o texto dos prompts é editável; registro de componentes, regras de layout e limites de QA ficam protegidos.',
    setStandardsLoadError: 'Falha ao carregar padrões. Tente novamente.',
    setStandardsSave: 'Salvar prompt',
    setStandardsReset: 'Restaurar padrão',
    setAiProbe: 'Detectar',
    setAiProbing: 'Detectando…',
    setAiMaxContext: 'Contexto máx. (tokens)',
    setAiMaxContextHint: 'Janela de entrada do modelo; preenchida após detectar',
    setAiMaxOutput: 'Saída máx. (tokens)',
    setAiMaxOutputHint: 'Teto de saída por resposta; preenchido após detectar',
    setAiVision: 'Suporta entrada de imagens (multimodal)',
    setAiVisionHint: 'Recursos de IA só enviam imagens quando ativado',
    setAiUnknown: 'Desconhecido',
    ...
    untitled: 'Sem título',
    noContent: '(vazio)',
    accountMetis: 'Conta Metis',
    account: 'Conta',
    login: 'Entrar',
    loginMetis: 'Entrar com a Metis',
    loggedIn: 'Conectado',
    loggedInMetis: 'Conectado à Metis',
    ...
    loginCopied: 'Copiado',
    loginNetworkError:
      'Não foi possível conectar ao Metis — verifique sua rede ou as configurações de proxy',
    ...
    setAiByokNote:
      'Todos os recursos de IA usam a chave de API configurada aqui; ela é armazenada apenas neste dispositivo.',
    setAiSave: 'Salvar',
    setAiSaved: 'Salvo',
  ...
  it: {
    ...
    navCloud: 'Metis Projects',
    cloudSubtitle:
      'Progetti creati sul web con Metis AI. La modifica continua nel browser: fai clic su un progetto per aprirlo.',
    ...
    cloudLoginHint: 'Accedi al tuo account Metis per vedere i progetti creati sul web.',
    ...
    importIntoProject: 'Importa file',
    setSecStandards: 'Standard',
    setStandardsNote:
      'È modificabile solo il testo dei prompt; registro componenti, regole di layout e soglie QA restano protette.',
    setStandardsLoadError: 'Caricamento standard non riuscito. Riprova.',
    setStandardsSave: 'Salva prompt',
    setStandardsReset: 'Ripristina predefinito',
    setAiProbe: 'Rileva',
    setAiProbing: 'Rilevamento…',
    setAiMaxContext: 'Contesto max (token)',
    setAiMaxContextHint: 'Finestra di input del modello; compilata dopo il rilevamento',
    setAiMaxOutput: 'Output max (token)',
    setAiMaxOutputHint: 'Limite di output per risposta; compilato dopo il rilevamento',
    setAiVision: 'Supporta input immagini (multimodale)',
    setAiVisionHint: 'Le funzioni IA inviano immagini solo se attivo',
    setAiUnknown: 'Sconosciuto',
    ...
    noContent: '(vuoto)',
    accountMetis: 'Account Metis',
    account: 'Account',
    login: 'Accedi',
    loginMetis: 'Accedi con Metis',
    loggedIn: 'Accesso effettuato',
    loggedInMetis: 'Accesso effettuato a Metis',
    ...
    loginCopied: 'Copiato',
    loginNetworkError:
      'Impossibile raggiungere Metis — controlla la rete o le impostazioni del proxy',
    ...
    setAiByokNote:
      'Tutte le funzioni IA usano la chiave API configurata qui; viene salvata solo su questo dispositivo.',
    setAiSave: 'Salva',
    setAiSaved: 'Salvato',
  ...
  pl: {
    ...
    navCloud: 'Metis Projects',
    cloudSubtitle:
      'Projekty utworzone w sieci za pomocą Metis AI. Edycja jest kontynuowana w przeglądarce — kliknij projekt, aby go otworzyć.',
    ...
    cloudLoginHint: 'Zaloguj się na konto Metis, aby zobaczyć projekty utworzone w sieci.',
    ...
    colSize: 'Rozmiar',
    newSlide: 'Nowe płótno',
    openLocal: 'Otwórz plik lokalny',
    importIntoProject: 'Importuj pliki',
    setSecStandards: 'Standardy',
    setStandardsNote:
      'Edytowalny jest tylko tekst promptów; rejestr komponentów, reguły układu i progi QA pozostają chronione.',
    setStandardsLoadError: 'Nie udało się wczytać standardów. Spróbuj ponownie.',
    setStandardsSave: 'Zapisz prompt',
    setStandardsReset: 'Przywróć domyślne',
    setAiProbe: 'Wykryj',
    setAiProbing: 'Wykrywanie…',
    setAiMaxContext: 'Maks. kontekst (tokeny)',
    setAiMaxContextHint: 'Okno wejściowe modelu; uzupełniane po wykryciu',
    setAiMaxOutput: 'Maks. wyjście (tokeny)',
    setAiMaxOutputHint: 'Limit wyjścia na odpowiedź; uzupełniane po wykryciu',
    setAiVision: 'Obsługuje obrazy (multimodalny)',
    setAiVisionHint: 'Funkcje AI wysyłają obrazy tylko po włączeniu',
    setAiUnknown: 'Nieznane',
    ...
    untitled: 'Bez tytułu',
    noContent: '(pusto)',
    accountMetis: 'Konto Metis',
    account: 'Konto',
    login: 'Zaloguj się',
    loginMetis: 'Zaloguj się przez Metis',
    loggedIn: 'Zalogowano',
    loggedInMetis: 'Zalogowano do Metis',
    waitingLogin:
    ...
    loginNetworkError: 'Nie można połączyć się z Metis — sprawdź sieć lub ustawienia proxy',
    ...
    setAiByokNote:
      'Wszystkie funkcje AI używają klucza API skonfigurowanego tutaj; jest on przechowywany tylko na tym urządzeniu.',
    setAiSave: 'Zapisz',
    setAiSaved: 'Zapisano',
  ...
  nl: {
    ...
    navCloud: 'Metis Projects',
    cloudSubtitle:
      'Projecten gemaakt op het web met Metis AI. Bewerken gaat verder in je browser — klik op een project om het te openen.',
    ...
    cloudLoginHint:
      'Log in op je Metis-account om projecten te zien die je op het web hebt gemaakt.',
    ...
    colSize: 'Grootte',
    newSlide: 'Nieuw canvas',
    openLocal: 'Lokaal bestand openen',
    importIntoProject: 'Bestanden importeren',
    setSecStandards: 'Standaarden',
    setStandardsNote:
      'Alleen prompttekst is bewerkbaar; componentregistry, layoutregels en QA-drempels zijn beschermd.',
    setStandardsLoadError: 'Standaarden konden niet worden geladen. Probeer opnieuw.',
    setStandardsSave: 'Prompt opslaan',
    setStandardsReset: 'Standaard herstellen',
    setAiProbe: 'Ontdekken',
    setAiProbing: 'Ontdekken…',
    setAiMaxContext: 'Max. context (tokens)',
    setAiMaxContextHint: 'Invoervenster van model; automatisch na ontdekken',
    setAiMaxOutput: 'Max. uitvoer (tokens)',
    setAiMaxOutputHint: 'Uitvoerlimiet per antwoord; automatisch na ontdekken',
    setAiVision: 'Ondersteunt beeldinvoer (multimodaal)',
    setAiVisionHint: 'AI-functies sturen alleen beelden indien ingeschakeld',
    setAiUnknown: 'Onbekend',
    ...
    account: 'Account',
    login: 'Inloggen',
    loginMetis: 'Inloggen met Metis',
    loggedIn: 'Ingelogd',
    loggedInMetis: 'Ingelogd bij Metis',
    ...
    loginNetworkError: 'Kan Metis niet bereiken — controleer uw netwerk of proxyinstellingen',
    ...
    setAiByokNote:
      'Alle AI-functies gebruiken de hier ingestelde API-sleutel; deze wordt alleen op dit apparaat opgeslagen.',
    setAiSave: 'Opslaan',
  ...
  ms: {
    ...
    navCloud: 'Metis Projects',
    cloudSubtitle:
      'Projek yang dicipta di web dengan Metis AI. Penyuntingan diteruskan dalam pelayar — klik projek untuk membukanya.',
    ...
    cloudLoginHint: 'Log masuk ke akaun Metis untuk melihat projek yang anda cipta di web.',
    ...
    colSize: 'Saiz',
    newSlide: 'kanvas baharu',
    openLocal: 'Buka Fail Setempat',
    importIntoProject: 'Import fail',
    setSecStandards: 'Piawai',
    setStandardsNote:
      'Hanya teks prompt boleh diedit; pendaftaran komponen, peraturan susun atur dan ambang QA dilindungi.',
    setStandardsLoadError: 'Gagal memuat piawai. Sila cuba lagi.',
    setStandardsSave: 'Simpan prompt',
    setStandardsReset: 'Set semula lalai',
    setAiProbe: 'esan model',
    setAiProbing: 'Mengesan…',
    setAiMaxContext: 'Konteks maks (token)',
    setAiMaxContextHint: 'Tetingkap input model; diisi automatik selepas pengesanan',
    setAiMaxOutput: 'Output maks (token)',
    setAiMaxOutputHint: 'Had output setiap balasan; diisi automatik selepas pengesanan',
    setAiVision: 'Sokong input imej (multimodal)',
    setAiVisionHint: 'Ciri AI hanya hantar imej jika diaktifkan',
    setAiUnknown: 'Tidak diketahui',
    greetMorning: 'Selamat pagi',
    ...
    noContent: '(kosong)',
    accountMetis: 'Akaun Metis',
    account: 'Akaun',
    login: 'Log masuk',
    loginMetis: 'Log masuk dengan Metis',
    loggedIn: 'Telah log masuk',
    loggedInMetis: 'Telah log masuk ke Metis',
    ...
    loginCopied: 'Disalin',
    loginNetworkError: 'Tidak dapat menyambung ke Metis — semak rangkaian atau tetapan proksi anda',
    ...
    setAiByokNote:
      'Semua ciri AI menggunakan kunci API yang dikonfigurasi di sini; ia disimpan pada peranti ini sahaja.',
    setAiSave: 'Simpan',
    setAiSaved: 'Disimpan',
  ...
  he: {
    ...
    navCloud: 'Metis Projects',
    cloudSubtitle:
      'פרויקטים שנוצרו באינטרנט עם Metis AI. העריכה נמשכת בדפדפן — לחצו על פרויקט כדי לפתוח אותו.',
    ...
    cloudRefresh: 'רענון',
    cloudLoginHint: 'התחברו לחשבון Metis כדי לראות פרויקטים שיצרתם באתר.',
    ...
    importIntoProject: 'ייבוא קבצים',
    setSecStandards: 'תקנים',
    setStandardsNote:
      'ניתן לערוך רק את טקסט הפרומפטים; רישום הרכיבים, כללי הפריסה וספי ה-QA מוגנים.',
    setStandardsLoadError: 'טעינת התקנים נכשלה. נסה שוב.',
    setStandardsSave: 'שמור פרומפט',
    setStandardsReset: 'שחזר ברירת מחדל',
    setAiProbe: 'זהה מודלים',
    setAiProbing: 'מזהה…',
    setAiMaxContext: 'הקשר מרבי (טוקנים)',
    setAiMaxContextHint: 'חלון הקלט של המודל; מתמלא אוטומטית לאחר זיהוי',
    setAiMaxOutput: 'פלט מרבי (טוקנים)',
    setAiMaxOutputHint: 'תקרת פלט לתשובה; מתמלא אוטומטית לאחר זיהוי',
    setAiVision: 'תומך בקלט תמונות (רב-מודלי)',
    setAiVisionHint: 'תכונות ה-AI שולחות תמונות רק כשמופעל',
    setAiUnknown: 'לא ידוע',
    ...
    untitled: 'ללא שם',
    noContent: '(ריק)',
    accountMetis: 'חשבון Metis',
    account: 'חשבון',
    login: 'התחברות',
    loginMetis: 'התחברות עם Metis',
    loggedIn: 'מחובר',
    loggedInMetis: 'מחובר ל-Metis',
    ...
    loginCopied: 'הועתק',
    loginNetworkError: 'לא ניתן להתחבר ל-Metis — בדקו את הרשת או את הגדרות ה-proxy',
    ...
    setAiByokNote:
      'כל תכונות הבינה המלאכותית משתמשות במפתח ה-API המוגדר כאן; הוא נשמר במכשיר זה בלבד.',
    setAiSave: 'שמירה',
    setAiSaved: 'נשמר',
  ...
  hi: {
    ...
    navCloud: 'Metis Projects',
    cloudSubtitle:
      'Metis AI के साथ वेब पर बनाए गए प्रोजेक्ट। संपादन ब्राउज़र में जारी रहता है — खोलने के लिए किसी प्रोजेक्ट पर क्लिक करें।',
    ...
    cloudLoginHint: 'वेब पर बनाए गए प्रोजेक्ट देखने के लिए अपने Metis खाते में साइन इन करें।',
    ...
    importIntoProject: 'फ़ाइलें आयात करें',
    setSecStandards: 'मानक',
    setStandardsNote:
      'केवल प्रॉम्प्ट टेक्स्ट संपादन योग्य है; घटक रजिस्ट्री, लेआउट नियम और QA सीमा सुरक्षित हैं।',
    setStandardsLoadError: 'मानक लोड करने में विफल। पुनः प्रयास करें।',
    setStandardsSave: 'प्रॉम्प्ट सहेजें',
    setStandardsReset: 'डिफ़ॉल्ट पर रीसेट करें',
    setAiProbe: 'मॉडल खोजें',
    setAiProbing: 'खोज रहे हैं…',
    setAiMaxContext: 'अधिकतम संदर्भ (टोकन)',
    setAiMaxContextHint: 'मॉडल इनपुट विंडो; खोज के बाद स्वतः भरें',
    setAiMaxOutput: 'अधिकतम आउटपुट (टोकन)',
    setAiMaxOutputHint: 'प्रति उत्तर आउटपुट सीमा; खोज के बाद स्वतः भरें',
    setAiVision: 'छवि इनपुट समर्थन (मल्टीमोडल)',
    setAiVisionHint: 'सक्रिय होने पर ही AI सुविधाएँ इस मॉडल को छवि भेजें',
    setAiUnknown: 'अज्ञात',
    ...
    noContent: '(खाली)',
    accountMetis: 'Metis खाता',
    account: 'खाता',
    login: 'साइन इन करें',
    loginMetis: 'Metis से साइन इन करें',
    loggedIn: 'साइन इन हो गया',
    loggedInMetis: 'Metis में साइन इन है',
    waitingLogin:
    ...
    loginNetworkError: 'Metis से कनेक्ट नहीं हो सका — नेटवर्क या प्रॉक्सी सेटिंग जांचें',
    ...
    setAiByokNote:
      'सभी AI सुविधाएँ यहाँ कॉन्फ़िगर की गई API key का उपयोग करती हैं; यह केवल इसी डिवाइस पर संग्रहीत रहती है।',
    setAiSave: 'सहेजें',
  ...
  'zh-TW': {
    ...
    navStarred: '收藏',
    navCloud: 'Metis Projects',
    cloudSubtitle: '在網頁端用 Metis AI 建立的專案。編輯在瀏覽器中繼續——點擊任意專案即可開啟。',
    ...
    cloudSortOldest: '最早',
    cloudRefresh: '重新整理',
    cloudLoginHint: '登入 Metis 帳號，查看你在網頁端建立的專案。',
    cloudEmpty: '還沒有網頁端專案。',
    ...
    newSlide: '新增畫布',
    openLocal: '開啟本機檔案',
    importIntoProject: '匯入檔案',
    setSecStandards: '規範',
    setStandardsNote: '僅可編輯 AI 繪圖的提示詞文字；元件註冊表、版面規則與 QA 閾值不可修改。',
    setStandardsLoadError: '規範載入失敗，請重試。',
    setStandardsSave: '儲存提示詞',
    setStandardsReset: '還原預設',
    setAiProbe: '探測模型',
    setAiProbing: '探測中…',
    setAiMaxContext: '最大上下文 (tokens)',
    setAiMaxContextHint: '模型輸入視窗上限；探測後自動填入',
    setAiMaxOutput: '最大輸出 (tokens)',
    setAiMaxOutputHint: '單次回覆的輸出上限；探測後自動填入',
    setAiVision: '支援圖片輸入（多模態）',
    setAiVisionHint: '勾選後 AI 功能才會向該模型傳送圖片',
    setAiUnknown: '未知',
    greetMorning: '早安',
    greetAfternoon: '午安',
    greetEvening: '晚安',
    ...
    untitled: '未命名',
    noContent: '（無內容）',
    accountMetis: 'Metis 帳號',
    account: '帳號',
    login: '登入',
    loginMetis: '登入 Metis 帳號',
    loggedIn: '已登入',
    loggedInMetis: '已登入 Metis',
    ...
    loginCopyUrl: '複製登入連結',
    loginCopied: '已複製',
    loginNetworkError: '無法連線至 Metis，請檢查網路或代理設定',
    ...
    setAiByokNote: '所有 AI 功能均使用你在此設定的 API Key；密鑰僅儲存在本機。',
    setAiSave: '儲存',
    setAiSaved: '已儲存',
    setAiTest: '測試連線',
    setAiTesting: '測試中…',
