...
/** Neutral AI assistant mark: a four-point sparkle, colored by currentColor. */
export function CopilotMark({ size = 30 }: { size?: number }) {
  return (
    ...
    >
      ...
      />
      <path
        d="M18.8 15.2c.42 2.14 1.34 3.06 3.45 3.48-2.11.42-3.03 1.34-3.45 3.48-.42-2.14-1.34-3.06-3.45-3.48 2.11-.42 3.03-1.34 3.45-3.48Z"
        fill="currentColor"
      />
    </svg>
  )
