...
/**
 * Phase 8 golden benchmark (GOAL §70): 50 cases across the required
 * categories. Each case is a semantic graph; the deterministic pipeline
 * (measure → candidates → solve → route → critic) must produce gate-clean
 * geometry with the composition intent preserved.
 */
...
describe('golden benchmark (52 cases, full orchestrator)', () => {
